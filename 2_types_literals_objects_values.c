...
----------------------|--------------|-----------------------------------|--------------------------
signed char           |  1           |    -128 to 127                    |    %c/%hhi
----------------------|--------------|-----------------------------------|--------------------------
unsigned char         |  1           |   0 to 255                        |    %c/%hhu
----------------------|--------------|-----------------------------------|--------------------------
short int             |  2           |   -32,768 to 32,767               |    %hd/%hi
----------------------|--------------|-----------------------------------|--------------------------
unsigned short int    |  2           |   0 to 65,535                     |    %hu
----------------------|--------------|-----------------------------------|--------------------------
unsigned int          |  4           |   0 to 4,294,967,295              |    %u
----------------------|--------------|-----------------------------------|--------------------------
int/signed int        |  4           |   -2,147,483,648 to 2,147,483,647 |    %d/%i
----------------------|--------------|-----------------------------------|--------------------------
long int              |  4           |   -2,147,483,648 to 2,147,483,647 |    %ld/%li
----------------------|--------------|-----------------------------------|--------------------------
unsigned long int     |  4           |   0 to 4,294,967,295              |    %lu
----------------------|--------------|-----------------------------------|--------------------------
long long int         |  8           |   -(2^63) to (2^63)-1             |    %lld/%lli
----------------------|--------------|-----------------------------------|--------------------------
unsigned long long int|  8           |   0 to 18,446,744,073,709,551,615 |    %llu
----------------------|--------------|-----------------------------------|--------------------------
float                 |  4           |   1.2E-38 to 3.4E+38	             |    %f/%F
----------------------|--------------|-----------------------------------|--------------------------
double                |  8           |   1.7E-308 to 1.7E+308	           |    %lf/%lF
----------------------|--------------|-----------------------------------|--------------------------
...
int main(int argc, char const *argv[])
{
  ...
  printf("Float Literals: %f ,%lf and %Lf\n", 5.435475785f, 4556.65845646, 123544.787945l);
  ...
  printf("Enum Literals: Mon- %d, Tues-%d, Wed-%d, Thurs-%d, Fri-%d, Sat-%d and Sun-%d\n", Mon, Tue, Wed, Thurs, Fri, Sat, Sun);
  return 0;
}
/*
